...
class AutoWeituomihanTask(BaseTask):
    ...
    def quit_level(self):
        ...
        self.sleep(1)
        self.click_color_to_color(common_color,"退出委托-确定",common_color,"副本退出-退出委托",x=796,y=430,out_time=60)
        self.sleep(1)
        print("退出成功")
    ...
    def combat_quli(self):
        ...
        while 1:
            ...
            if is_get_award:
                ...
                if res:
                    self.sleep(1)
                    if self.find_my_color(common_color,"副本退出-退出委托"):
                        print("战斗完成")
                        return True
