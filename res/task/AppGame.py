...
class AppGame:
    ...
    def open_game(self):
        ...
        find_num = 0    # 查找到血条的次数，当查找到3次后才算启动成功
        ...
        while True:
            ...
            if self.base_task.is_text_re_in_ocr(rect=[552,588,727,627], pattern="不再"):
                self.base_task.click(1183, 126,after_sleep=6)
                time.sleep(1)
            ...
            if self.base_task.is_text_re_in_ocr(rect=[561,70,727,139],pattern="获得物品"):
                ...
                # 关闭窗口
                self.base_task.click(1126, 150, after_sleep=3)
