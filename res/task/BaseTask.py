...
class BaseTask(BaseAction, BaseFind):
    ...
    def role_restoration(self):
        ...
        self.sleep(1)
        self.click_until_ocr(x=49,y=395,rect=[938,563,1251,616],pattern="复位角色")
        self.sleep(1)
        self.click_color_to_color(common_color,"左上角红色退出",common_color,"设置-重置位置-确定",x=1089,y=589)
        self.sleep(1)
        self.click_color_to_color(common_color,"设置-重置位置-确定",common_color,"角色血条-绿色",x=774,y=412)
        self.sleep(1)
        print("角色复位成功")
